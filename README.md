...
This plugin only has a mandatory dependency on the webhdfs gem from Kazuki Ohta (@see: https://github.com/kzk/webhdfs). Optional dependencies are zlib and snappy gem.
